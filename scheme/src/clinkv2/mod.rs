...
/// Create proofs for the Clinkv2 construction.
pub mod prover;
pub mod r1cs;
use self::r1cs::{Index, LinearCombination, SynthesisError};
use self::prover::{KZG10_Proof, KZG10_Comm};

// use self::{prover::*};
// use self::{r1cs::*};

use poly_commit::kzg10;
//::{Proof as KZG10_Proof, UniversalParams as KZG10_Params, Commitment as KZG10_Comm};
// pub type KZG10_Proof<E> = kzg10::Proof<E>;
// pub type KZG10_Comm<E> = kzg10::Commitment<E>;

/// Verify proofs for the Clinkv2 construction.
//pub mod verifier;
